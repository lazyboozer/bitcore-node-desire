  ...
  describe('#govObject', function() {
        ...
        var gobject = sinon.stub().callsArgWith(1, null, {
            result: [{
                ...
                "DataObject": {
                    ...
                    "type": 1,
                    "url": "https://www.desire-crypto.com"
                },
                "AbsoluteYesCount": 0,
                "YesCount": 0,
                "NoCount": 0,
    ...
    it('will call client gobject get and give result', function(done) {
      ...
      var gobject = sinon.stub().callsArgWith(2, null, {
        result: {
          "DataHex": "",
          "DataString": "[[\"proposal\",{\"end_epoch\":1483855193,\"name\":\"7ea9acff5ae83d8c9e217d30a2b4d10ef8f171f8\",\"payment_address\":\"yZ7DYkDHCHfH1dw7rKdYaKcVykZmunbqNL\",\"payment_amount\":84,\"start_epoch\":1483765282,\"type\":1,\"url\":\"https://www.desire-crypto.com\"}]]",
          "Hash": "4ef24027c631c43035aa4cf5c672e1298311decd9cffbd16731f454c9c0d6d00",
      ...
      bitcoind.govObjectHash('4ef24027c631c43035aa4cf5c672e1298311decd9cffbd16731f454c9c0d6d00', function(err, result) {
        ...
        should.equal(DataObject.url, 'https://www.desire-crypto.com');
        done();
      });
    });
